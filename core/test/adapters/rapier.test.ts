...
let RAPIER_OK = false;
let sim: ForwardSim<CarKinematicState> | null = null;
try {
...
describe.skipIf(!RAPIER_OK)('rapierForwardSim', () => {
  ...
  it('turns the body under a curvature command', () => {
    const s: CarKinematicState = { x: 0, z: 0, heading: 0, speed: 0, t: 1 };
  ...
  it('is deterministic for identical inputs', () => {
    const s: CarKinematicState = { x: 1, z: 2, heading: 0.3, speed: 0, t: 0 };
