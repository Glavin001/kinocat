...
function splitAtGearCusps(plan: CarKinematicState[]): CarKinematicState[][] {
...
function trimPlan(plan: CarKinematicState[], elapsed: number): CarKinematicState[] {
  let i = 0;
